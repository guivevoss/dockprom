...
Dans une console à la racine de ce projet
...
* Prometheus  `http://<ip-hôte>:9090`
* Prometheus-Pushgateway  `http://<ip-hôte>:9091`
* AlertManager `http://<ip-hôte>:9093`
* Grafana  `http://<ip-hôte>:3000`
* NodeExporter 
* cAdvisor 
* Caddy 
...
Dans un navigateur `http://<ip-hôte>:3000` 

Les accès : ***admin*** / ***admin***. 
...
You can find right value for your system in Prometheus `http://<ip-hôte>:9090` launching this request :
...
```
curl -X POST http://admin:admin@<ip-hôte>:9090/-/reload
```
...
You can view and silence notifications by accessing `http://<ip-hôte>:9093`.
